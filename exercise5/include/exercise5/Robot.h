...
#ifndef EXERCISE5_ROBOT_H
#define EXERCISE5_ROBOT_H
...
public:
    ...
    Robot(std::string PLANNING_GROUP);
    ...
    /** @brief Compute plan between start state and goal pose; Return empty trajectory on error and print error. */
    moveit_msgs::RobotTrajectory
    planToPose(const robot_state::RobotState &start, const geometry_msgs::Pose &goal);
